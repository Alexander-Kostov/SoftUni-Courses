...
@Entity(name = "p01_wizard_deposits")
public class WizardDeposits {
    ...
    public WizardDeposits(int id, String firstName, String lastName, String notes, int age,
                          String magicWandCreator, short magicWandSize, String depositGroup, LocalDateTime depositStartDate,
