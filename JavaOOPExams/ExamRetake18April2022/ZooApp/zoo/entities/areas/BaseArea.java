...
public abstract class BaseArea implements Area {
    ...
    public String getInfo() {
        String animalOutput = animals.isEmpty() ? "none" : animals.stream().
                map(Animal::getName).collect(Collectors.joining(" "));
        return String.format("%s (%s):%n" +
                "Animals: %s%n" +
                "Foods: %d%n" +
                "Calories: %d", name, getClass().getSimpleName(), animalOutput, foods.size(), sumCalories());
    }
